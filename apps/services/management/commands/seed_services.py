...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        services_data = [
            ...
            {'name': 'Silver Caballero', 'slug': 'silver-caballero', 'price': 30000,
             'duration_minutes': 60, 'features': ['Corte', 'Lavado con shampoo específico', 'Masaje capilar', 'Estilismo', 'Bebidas ilimitadas']},
            {'name': 'Silver Dama', 'slug': 'silver-dama', 'price': 35000,
             'duration_minutes': 60, 'features': ['Corte sencillo', 'Despunte recto', 'En forma de U o V']},
            {'name': 'Gold Caballero', 'slug': 'gold-caballero', 'price': 65000,
             'duration_minutes': 90, 'features': ['Corte', 'Lavado con shampoo específico', 'Masaje capilar', 'Masaje cervical', 'Estilismo', 'Arreglo de barba o diseño de cejas', 'Estilismo', 'Una (1) bebida nacional']},
            {'name': 'Gold Dama', 'slug': 'gold-dama', 'price': 50000,
             'duration_minutes': 90, 'features': ['Corte sencillo', 'Despunte recto', 'En forma de U o V', 'Shampoo', 'Tratamiento', 'Masaje capilar']},
            {'name': 'Diamond Caballero', 'slug': 'diamond-caballero', 'price': 115000,
             'duration_minutes': 120, 'features': []},
            {'name': 'Diamond Dama', 'slug': 'diamond-dama', 'price': 70000,
             'duration_minutes': 120, 'features': []},
        ]

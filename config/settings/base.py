...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'apps.users.context_processors.admin_badges',
            ],
        },
    },
]
...
# Correo exclusivo de Frank para notificaciones del sistema (nuevas reservas, cancelaciones, etc.)
EMAIL_ADMIN = os.environ.get('SMTP_ADMIN', 'frankodraw@gmail.com')
